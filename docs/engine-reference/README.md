...
Opencode's training data has a knowledge cutoff (currently May 2025). Game engines
like Godot, Unity, Unreal, and GameMaker ship updates that introduce breaking API changes,
