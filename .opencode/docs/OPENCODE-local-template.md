# OPENCODE.local.md Template

Copy this file to the project root as `OPENCODE.local.md` for personal overrides.
...
1. Copy this template to your project root: `cp .opencode/docs/OPENCODE-local-template.md OPENCODE.local.md`
2. Edit to match your preferences
3. Verify `OPENCODE.local.md` is in `.gitignore` (Opencode reads it from the project root)
