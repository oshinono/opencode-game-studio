...
| ---- | ---- |
| **Recommended Engine** | [Godot / Unity / Unreal / GameMaker and why — consider scope, team expertise, platform targets] |
...
- [ ] Fill in OPENCODE.md technology stack based on engine choice (`/setup-engine`)
